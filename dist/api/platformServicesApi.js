...
var PlatformServicesApiApiKeys;
(function (PlatformServicesApiApiKeys) {
    PlatformServicesApiApiKeys[PlatformServicesApiApiKeys["api"] = 0] = "api";
})(PlatformServicesApiApiKeys = exports.PlatformServicesApiApiKeys || (exports.PlatformServicesApiApiKeys = {}));
var PlatformServicesApi = (function () {
    function PlatformServicesApi(oAuth, basePath) {
    ...
    Object.defineProperty(PlatformServicesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PlatformServicesApi.prototype, "basePath", {
        get: function () {
    ...
    PlatformServicesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PlatformServicesApi.prototype.setApiKey = function (key, value) {
        this.authentications[PlatformServicesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PlatformServicesApi.prototype, "oAuth", {
        set: function (oAuth) {
    ...
    Object.defineProperty(PlatformServicesApi.prototype, "tokenUrl", {
    ...
    Object.defineProperty(PlatformServicesApi.prototype, "clientId", {
    ...
    Object.defineProperty(PlatformServicesApi.prototype, "clientSecret", {
    ...
    PlatformServicesApi.prototype.listManagedServices = function (service, operationRequest, data, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/manage/{service}'
                ...
                if (data !== undefined) {
                    localVarQueryParameters['data'] = models_1.ObjectSerializer.serialize(data, "string");
                }
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(operationRequest, "OperationRequest")
                };
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Array<OperationTargetResponse>");
    ...
    PlatformServicesApi.prototype.manageService = function (service, operationRequest, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "OperationResponse");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    PlatformServicesApi.prototype.platformInfo = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/info';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
    ...
    return PlatformServicesApi;
}());
exports.PlatformServicesApi = PlatformServicesApi;
//# sourceMappingURL=platformServicesApi.js.map