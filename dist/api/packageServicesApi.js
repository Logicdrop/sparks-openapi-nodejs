...
var PackageServicesApiApiKeys;
(function (PackageServicesApiApiKeys) {
    PackageServicesApiApiKeys[PackageServicesApiApiKeys["api"] = 0] = "api";
})(PackageServicesApiApiKeys = exports.PackageServicesApiApiKeys || (exports.PackageServicesApiApiKeys = {}));
var PackageServicesApi = (function () {
    function PackageServicesApi(oAuth, basePath) {
    ...
    Object.defineProperty(PackageServicesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PackageServicesApi.prototype, "basePath", {
        get: function () {
    ...
    PackageServicesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PackageServicesApi.prototype.setApiKey = function (key, value) {
        this.authentications[PackageServicesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PackageServicesApi.prototype, "oAuth", {
        set: function (oAuth) {
    ...
    Object.defineProperty(PackageServicesApi.prototype, "tokenUrl", {
    ...
    Object.defineProperty(PackageServicesApi.prototype, "clientId", {
    ...
    Object.defineProperty(PackageServicesApi.prototype, "clientSecret", {
    ...
    PackageServicesApi.prototype.deletePackage = function (client, _package, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/packages/{client}/{package}'
    ...
    PackageServicesApi.prototype.getPackage = function (client, _package, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Bundle");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    PackageServicesApi.prototype.listPackages = function (client, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/packages/{client}'
                    .replace('{' + 'client' + '}', encodeURIComponent(String(client)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                produces = ['application/json'];
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Array<Bundle>");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    PackageServicesApi.prototype.scaffoldProject = function (client, scaffoldRequest, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/packages/{client}/scaffold'
                    .replace('{' + 'client' + '}', encodeURIComponent(String(client)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                produces = ['application/json'];
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(scaffoldRequest, "ScaffoldRequest")
                };
                authenticationPromise = Promise.resolve();
                authenticationPromise = authenticationPromise.then(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "ScaffoldResult");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    PackageServicesApi.prototype.uploadPackage = function (client, file, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    return PackageServicesApi;
}());
exports.PackageServicesApi = PackageServicesApi;
//# sourceMappingURL=packageServicesApi.js.map